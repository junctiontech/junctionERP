...
public function insert_employee($info=false)
	...
	{
		$application_registration_list=$this->data['application_registration_list']=$this->employee_model->application_registration_list();print_r($application_registration_list);
		$this->parser->parse('include/header',$this->data);
		$this->parser->parse('include/left_menu',$this->data);
