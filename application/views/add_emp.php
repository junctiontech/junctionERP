...
<!-- Add emp body starts -->
		...
		<div class="page-title">
			...
			<form role="forl" id="rootwizard" class="form-wizard validate" method="POST" action="<?=base_url();?>employee/update_employee/<?=$id?>/<?=$list->employee_id?>" enctype="multipart/form-data" >
					...
					<div class="row">
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" class="form-control" name="employee_id" value="<?=$list->employee_id;?>" id="empid" data-validate="required,minlength[5]" data-message-minlength="Emp id must have minimum of 5 chars." placeholder="Enter Emp id" readonly/>
							</div>
						</div>
						</div>
						<div class="col-md-6">	
							<div class="form-group">
									...
									<div class="">
										<input type="text" name="joining_date" value="<?=$list->joining_date;?>" class="form-control datepicker" data-start-view="1">
									</div>
								</div>
								</div>
							</div>
						...
						<div class="col-md-6">						
								<div class="form-group">
									...
									<select name="department_name" class="selectboxit">
										...
										<option value="<?php echo $lists->department_id; ?>" <?=($lists->department_id==$list->department_id)?'selected':''?> ><?php echo $lists->department_name; ?></option>
										<?php } ?>
										</optgroup>
						...
						<div class="col-md-6">						
								<div class="form-group">
									...
									<select name="designation_name" class="selectboxit">
										...
										<option value="<?php echo $lists->designation_id; ?>" <?=($lists->designation_id==$list->designation_id)?'selected':''?>><?php echo $lists->designation_name; ?></option>	
											<?php } ?>
										</optgroup>
									</select>
							...
							<div class="form-group">
								<label class="control-label">Username</label>
									<div class="input-group">
										...
										<input type="text" class="form-control" name="username" value="username" id="username" data-validate="required,minlength[5]" data-message-minlength="User Name must have minimum of 5 chars." placeholder="Could be email id" />
								</div>
							</div>
						</div>
						<div class="col-md-6">						
